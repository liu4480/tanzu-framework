...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NsxCertRef) DeepCopyInto(out *NsxCertRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NsxCertRef.
func (in *NsxCertRef) DeepCopy() *NsxCertRef {
	if in == nil {
		return nil
	}
	out := new(NsxCertRef)
